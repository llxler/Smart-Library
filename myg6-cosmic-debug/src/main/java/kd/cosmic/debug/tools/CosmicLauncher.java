...
public final class CosmicLauncher {
    ...
    private static final String PROJECT_HOME = "C:/Users/24996/kingdee/cosmic";
    ...
    private String cosmicUrl = "http://" + MY_IP + ":" + cosmicPort + "/ierp";
    ...
    public void setDefault() {
        ...
        if (!useMcServiceConfigFirst) {
            ...
            setConfigUrl(MY_IP + ":2181");
            setMcServerUrl("http://" + MY_IP + ":8090");
            setFsServerUrl(MY_IP, 8100);
            setImageServerUrl(MY_IP, 8100);
...
//    	LOG.info("Cosmic Service starting! Please check url: {}", getCosmicUrl());
    ...
    public void setCosmicWepPort(int port) {
        ...
        this.cosmicUrl = "http://" + MY_IP + ":" + cosmicPort + "/ierp";
