        ...
        if ("GENERATE_FILE_DOC".equalsIgnoreCase(action)) {
            ...
            try {
                ...
                try (FileOutputStream fos = new FileOutputStream(targetFile)) {
                    ...
                    path = fs.upload(fi);
                    // 拼接URL，将最终的URL输出
                    result.put("endUrl", System.getProperty("domain.contextUrl") + "/attachment/download.do?path=" + path + "&method=autoJump&title=分析报告.xml&iconType=document");
