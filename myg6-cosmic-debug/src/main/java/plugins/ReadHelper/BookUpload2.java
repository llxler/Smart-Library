...
public class BookUpload2 extends AbstractFormPlugin implements UploadListener {
    ...
    private String loadTextFileString(String fileUrl) {
        ...
        try {
            ...
            cache.put("fileName", fileBaseName);

            System.out.println("fileName : " + fileName);
            String fileExtension = getFileExtension(fileName);

            if ("txt".equalsIgnoreCase(fileExtension)) {
                try (FileOutputStream fileOutputStream = new FileOutputStream("D:\\UseForRuanjianbei\\pdf2txt\\output.txt")) {
                ...
                // 保存文件以便后续处理
                String pdfFilePath = "D:\\UseForRuanjianbei\\pdf2txt\\input.pdf";
                ...
                String txtFilePath = "D:\\UseForRuanjianbei\\pdf2txt\\output.txt";
    ...
    private static void convertPdfToTxtWithPython(String pdfPath, String txtPath) {
        try {
            // 构建 Python 命令
            String[] command = {"d://Code//Anaconda//python.exe", "D:\\UseForRuanjianbei\\pdf2txt\\main.py", pdfPath, txtPath};
