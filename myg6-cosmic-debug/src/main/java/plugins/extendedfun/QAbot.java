 ...
 * 动态表单插件
 */
public class QAbot extends AbstractFormPlugin implements Plugin {
    @Override
    ...
    public void click(EventObject evt) {
        ...
        if (source instanceof Button) {
            ...
            if (StringUtils.equals("btnok", key)) {
                ...
                // 获取问题难度
                BigDecimal diff = (BigDecimal) this.getModel().getValue("myg6_stepperfield2");
                System.out.println("问答难度" + diff);
                jsonResultObject.put("diff", diff);
                // 调用GPT开发平台微服务
