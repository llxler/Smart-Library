...
public class ActivityContain29 extends AbstractFormPlugin {
...
//        }
    ...
    public void beforeBindData(EventObject e) {
        ...
        for (Date da : newsDate) {
            ...
            System.out.println("Fuck" + texti + texti.length());
...
//            System.out.println("fuck" + dates[i] + i);
            ...
            propsMap = new HashMap<>();
            propsMap.put("imageKey","http://10.21.204.111:8881/ierp/attachment/downloadImage/" + urli);
