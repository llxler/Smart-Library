 ...
 * 动态表单插件
 */
public class ActivityRendering14 extends AbstractFormPlugin implements Plugin {
...
//            文字部分赋值
            if (!largetextfield1.isEmpty()) {
                Label label1 = this.getView().getControl("myg6_labelapt1");
                label1.setText(largetextfield1);
            }
            else{
            ...
            if (!largetextfield2.isEmpty()) {
                ...
                Label label2 = this.getView().getControl("myg6_labelapt2");
                System.out.println("fuck2");

                label2.setText(largetextfield2);
            ...
            if (!largetextfield3.isEmpty()) {
                Label label3 = this.getView().getControl("myg6_labelapt3");
                label3.setText(largetextfield3);
            }
            else{
                this.getView().setVisible(false, "myg6_labelapt3");
            }
            if (!largetextfield4.isEmpty()) {
                Label label4 = this.getView().getControl("myg6_labelapt4");
                label4.setText(largetextfield4);
            }
            else{
