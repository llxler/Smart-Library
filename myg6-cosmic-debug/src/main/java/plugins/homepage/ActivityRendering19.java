 ...
 * 动态表单插件
 */
public class ActivityRendering19 extends AbstractFormPlugin implements Plugin {
    public void afterCreateNewData(EventObject e) {
        super.afterCreateNewData(e);
        FormShowParameter showParameter = this.getView().getFormShowParameter();
        String openTitle = showParameter.getCustomParam("openTitle");
        QFilter qFilter = new QFilter("myg6_title", QCP.equals, openTitle);
